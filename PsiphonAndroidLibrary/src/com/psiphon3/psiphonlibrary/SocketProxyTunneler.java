...
/*
 * The following is mostly copied from org.apache.http.impl.client.ProxyClient
 * the tunnel(...) method is modified to do HTTP tunneling on an already connected 
 * socket 
 */
...
public class SocketProxyTunneler {
