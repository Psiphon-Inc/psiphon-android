...
class InternalMethods
{
    ...
    /**
     * @return <code>0</code> if your app has been granted root access.
     * @return <code>1</code> if your app has been denied root access.
     * @return <code>-1</code> if access status is undetermined (e.g., timeout on Superuser prompt).
     */
    static int isAccessGiven() {
        /*
        try {
