...
/////////////////
    ...
    */
    public void start() throws IOException{
       ...
       Log.d("JSocks", "Starting UDP relay server on "+relayIP+":"+relayPort);
       Log.d("JSocks", "Remote socket "+remote_sock.getLocalAddress()+":"+
...
////////////////////
    public void run(){
       try{
          ...
          abort();
          Log.d("JSocks", "UDP Pipe thread "+Thread.currentThread().getName()+" stopped.");
       }
...
/////////////////
    private synchronized void abort(){
       ...
       Log.d("JSocks", "Aborting UDP Relay Server");
    ...
    private void pipe(DatagramSocket from,DatagramSocket to,boolean out)
       ...
       while(true){
          try{
            ...
            Log.e("JSocks", "Dropping datagram for unknown host");
          }catch(InterruptedIOException iioe){
            //Log.d("JSocks", "Interrupted: "+iioe);
