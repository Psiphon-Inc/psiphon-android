...
public class AppInstallUnlockHandler extends UnlockOptionHandler {
    ...
    protected View createView(ViewGroup parent) {
        ...
        appNameText.setText(parent.getContext().getString(R.string.install_app_to_unlock_title_common, appEntry.appName));
        descriptionText.setText(parent.getContext().getString(R.string.install_app_to_unlock_description_common, appEntry.appName));
