...
public class ConduitUnlockHandler extends UnlockOptionHandler {
    ...
    private static final String PLAYSTORE_PSIPHON_GP_URL =
    ...
    private View updatePsiphonView;
    ...
    protected View createView(ViewGroup parent) {
        ...
        updatePsiphonView = view.findViewById(R.id.updatePsiphonView);
        ...
        CardView updatePsiphonCard = view.findViewById(R.id.updatePsiphonCardView);
        ...
        updatePsiphonCard.setOnClickListener(v -> openPlayStorePsiphon(v.getContext()));
    ...
    private void hideAllConduitViews() {
        if (updatePsiphonView != null) {
            updatePsiphonView.setVisibility(View.GONE);
        }
    ...
    private void openPlayStorePsiphon(android.content.Context context) {
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setData(Uri.parse(PLAYSTORE_PSIPHON_GP_URL));
        intent.setPackage("com.android.vending");
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        try {
            if (actionRunnable != null) {
            ...
            MyLog.i("ConduitUnlockHandler: opening Play Store for Psiphon");
            context.startActivity(intent);
            dismissDialogRunnable.run();
        } catch (ActivityNotFoundException e) {
            MyLog.w("ConduitUnlockHandler: Play Store not found for: " + PLAYSTORE_PSIPHON_GP_URL);
        }
    }
