// https://github.com/googlesamples/android-play-billing/blob/66f20e5236e1fd6c793592ded8132a0d1d427e2e/TrivialDrive/app/src/main/java/com/example/android/trivialdrivesample/util/IabHelper.java
...
public class IabHelper {
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
        ...
        try {
            ...
            throw new IabException(IABHELPER_UNKNOWN_ERROR, "Null pointer exception while refreshing inventory.", e);
        }
    }
