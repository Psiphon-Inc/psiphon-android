...
public class MoreOptionsPreferenceActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getFragmentManager().beginTransaction().replace(android.R.id.content, new MoreOptionsPreferenceFragment()).commit();
    }

    public static class MoreOptionsPreferenceFragment extends PreferenceFragment implements OnSharedPreferenceChangeListener, OnPreferenceClickListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            AppPreferences mpPreferences = new AppPreferences(getActivity());
