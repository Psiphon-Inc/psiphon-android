...
//[[[end]]]
    ...
    public static void initialize(Context context)
    {
        ...
        mpPreferences.migrate(
                new SharedPreferencesImport(context, prefFileName, PROPAGATION_CHANNEL_ID_PREFERENCE, PROPAGATION_CHANNEL_ID_PREFERENCE),
                new SharedPreferencesImport(context, prefFileName, SPONSOR_ID_PREFERENCE, SPONSOR_ID_PREFERENCE),
                new SharedPreferencesImport(context, prefFileName, REMOTE_SERVER_LIST_URL_PREFERENCE, REMOTE_SERVER_LIST_URL_PREFERENCE),
                new SharedPreferencesImport(context, prefFileName, REMOTE_SERVER_LIST_SIGNATURE_PUBLIC_KEY_PREFERENCE, REMOTE_SERVER_LIST_SIGNATURE_PUBLIC_KEY_PREFERENCE),
                new SharedPreferencesImport(context, prefFileName, INFO_LINK_URL_PREFERENCE, INFO_LINK_URL_PREFERENCE),
                new SharedPreferencesImport(context, prefFileName, UPGRADE_URL_PREFERENCE, UPGRADE_URL_PREFERENCE),
                new SharedPreferencesImport(context, prefFileName, UPGRADE_SIGNATURE_PUBLIC_KEY_PREFERENCE, UPGRADE_SIGNATURE_PUBLIC_KEY_PREFERENCE),
        ...
        {
            mpPreferences.put(PROPAGATION_CHANNEL_ID_PREFERENCE, PROPAGATION_CHANNEL_ID);
            mpPreferences.put(SPONSOR_ID_PREFERENCE, SPONSOR_ID);
            mpPreferences.put(REMOTE_SERVER_LIST_URL_PREFERENCE, REMOTE_SERVER_LIST_URL);
            mpPreferences.put(REMOTE_SERVER_LIST_SIGNATURE_PUBLIC_KEY_PREFERENCE, REMOTE_SERVER_LIST_SIGNATURE_PUBLIC_KEY);
            mpPreferences.put(INFO_LINK_URL_PREFERENCE, INFO_LINK_URL);
            mpPreferences.put(UPGRADE_URL_PREFERENCE, UPGRADE_URL);
            mpPreferences.put(UPGRADE_SIGNATURE_PUBLIC_KEY_PREFERENCE, UPGRADE_SIGNATURE_PUBLIC_KEY);
        ...
        {
            PROPAGATION_CHANNEL_ID = mpPreferences.getString(PROPAGATION_CHANNEL_ID_PREFERENCE, PROPAGATION_CHANNEL_ID);
            SPONSOR_ID = mpPreferences.getString(SPONSOR_ID_PREFERENCE, SPONSOR_ID);
            REMOTE_SERVER_LIST_URL = mpPreferences.getString(REMOTE_SERVER_LIST_URL_PREFERENCE, REMOTE_SERVER_LIST_URL);
            REMOTE_SERVER_LIST_SIGNATURE_PUBLIC_KEY = mpPreferences.getString(REMOTE_SERVER_LIST_SIGNATURE_PUBLIC_KEY_PREFERENCE, REMOTE_SERVER_LIST_SIGNATURE_PUBLIC_KEY);
            INFO_LINK_URL = mpPreferences.getString(INFO_LINK_URL_PREFERENCE, INFO_LINK_URL);
            UPGRADE_URL = mpPreferences.getString(UPGRADE_URL_PREFERENCE, UPGRADE_URL);
            UPGRADE_SIGNATURE_PUBLIC_KEY = mpPreferences.getString(UPGRADE_SIGNATURE_PUBLIC_KEY_PREFERENCE, UPGRADE_SIGNATURE_PUBLIC_KEY);
    ...
    public static boolean hasEverBeenSideLoaded(Context context)
    {
        if (IS_PLAY_STORE_BUILD)
        {
            AppPreferences mpPreferences = new AppPreferences(context);
            try {
                mpPreferences.getString(PROPAGATION_CHANNEL_ID_PREFERENCE);
