...
public class InterstitialAdViewModel extends AndroidViewModel implements LifecycleObserver {
    ...
    public Observable<PsiphonAdManager.InterstitialResult> getInterstitialResultObservable() {
        if (PsiphonAdManager.shouldShowAds(application.getApplicationContext())) {
    ...
    public void startUp() {
        ...
        Completable countdownCompletable =
        ...
        Observable<PsiphonAdManager.InterstitialResult> interstitialResultObservable =
