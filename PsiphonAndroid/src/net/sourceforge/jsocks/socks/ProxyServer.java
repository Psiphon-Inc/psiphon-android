      ...
      switch(mode){
        case START_MODE:
         try{
           ...
           Log.d("JSocks", connectionId + " Main thread(client->remote)stopped.");
         }
        break;
        case ACCEPT_MODE:
          try{
            ...
            abort();
            Log.d("JSocks", connectionId + " Accept thread(remote->client) stopped");
          }
        break;
        case PIPE_MODE:
         try{
            ...
            abort();
            Log.d("JSocks", connectionId + " Support thread(remote->client) stopped");
         }
        break;
        case ABORT_MODE:
        break;
        default:
            Log.d("JSocks", connectionId + " Unexpected MODE " + mode);
      }
   }
...
/////////////////
   private void startSession() throws IOException{
     ...
     try{
       ...
       Log.e("JSocks", connectionId + " Auth exception", ioe);
       auth = null;
       return;
     }

     if(auth == null){ //Authentication failed
        Log.e("JSocks", connectionId + " Authentication failed");
        return;
     }
   ...
   private void onConnect(ProxyMessage msg) throws IOException{
      ...
      Log.d("JSocks", connectionId + " Connected to " + s.getInetAddress() + ":" +
          s.getPort());
   ...
   private void onBind(ProxyMessage msg) throws IOException{
      ...
      Log.d("JSocks", connectionId + " Trying accept on " + ss.getInetAddress() + ":" + 
          ss.getLocalPort());
   ...
   private void onUDP(ProxyMessage msg) throws IOException{
      ...
      Log.d("JSocks", connectionId + " Creating UDP relay server for " +  msg.ip +
          ":" + msg.port);
...
//////////////////
   ...
   private void doAccept() throws IOException{
      ...
      Log.d("JSocks", connectionId + " Accepted from "+ s.getInetAddress() + ":" + 
          s.getPort());
   ...
   private synchronized void abort(){
      ...
      mode = ABORT_MODE;
      try{
         Log.d("JSocks", connectionId + " Closing connection.");
